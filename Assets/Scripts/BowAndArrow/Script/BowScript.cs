...
namespace DigitalRuby.BowAndArrow
{
    ...
    public class BowScript : MonoBehaviour
    {
        ...
        private Vector3 GetArrowPositionForDraw()
        {
            ...
            // nếu họ đang kéo cung, nhưng nó quá xa về phía trước, hãy đặt vị trí kéo về một vị trí tối thiểu nào đó về phía sau
            ...
            {
                // nếu họ đã kéo cung quá xa về phía sau, hãy buộc nó ở khoảng cách tối đa
        ...
        {
            //nếu chúng ta vẫn ở trong khu vực tốt để rút cung, hãy tiếp tục kéo cung lại
            if (!AllowFizzling || DrawTotalArea.OverlapPoint(Camera.main.ScreenToWorldPoint(Input.mousePosition)))
            {
                ...
                // đặt vị trí và xoay mũi tên đó dựa trên khoảng cách kéo cung ra sau
